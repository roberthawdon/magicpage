...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../MP-Uploaded/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../MP-Uploaded/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt,pdf,bmp,doc,docx,xls,xlsx,ppt,pptx,zip,rar,7z,tar,gz,bz2'); // 
